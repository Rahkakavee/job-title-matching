...
bert_vectorizer = BertVectorizer(
    train_sentences=train_sentences,
    test_sentences=test_sentences,
    modelname="src/vectorizer/BERT/bert_fine_tuning_level1",
)
...
# Comparison of vectorization techniques - SVM
predictions_counting_SVM = []
create_predicition_data(
    predictions_count_SVM,
    predictions_counting_SVM,
    name="count",
    format_dict_=False,
    divider=len(predictions_count_SVM),
)

create_predicition_data(
    predictions_tfidf_SVM,
    predictions_counting_SVM,
    name="tfidf",
    format_dict_=False,
    divider=len(predictions_tfidf_SVM),
)

create_predicition_data(
    predictions_word2vec_without_SVM,
    predictions_counting_SVM,
    name="word2vec_I",
    format_dict_=False,
    divider=len(predictions_word2vec_without_SVM),
)

create_predicition_data(
    predictions_doc2vec_without_SVM,
    predictions_counting_SVM,
    name="doc2vec_I",
    format_dict_=False,
    divider=len(predictions_doc2vec_without_SVM),
)

create_predicition_data(
    predictions_bert_SVM,
    predictions_counting_SVM,
    name="bert",
    format_dict_=False,
    divider=len(predictions_bert_SVM),
)

ax = plot_countings(predictions_counting_SVM, palette_01, "frequency (%)")
fig = ax.get_figure()
fig.savefig("visualization/results/level1/predictions_SVM_L1.jpg")
...
# Comparison of additional knowledge - SVM
predictions_counting_SVM_word_doc = []
create_predicition_data(
    predictions_word2vec_without_SVM,
    predictions_counting_SVM_word_doc,
    name="word2vec_I",
...
create_predicition_data(
    predictions_word2vec_with_SVM,
    predictions_counting_SVM_word_doc,
    name="word2vec_II",
    format_dict_=False,
    divider=len(predictions_word2vec_with_SVM),
)

create_predicition_data(
    predictions_doc2vec_with_SVM,
    predictions_counting_SVM_word_doc,
    name="doc2vec_II",
    format_dict_=False,
    divider=len(predictions_doc2vec_with_SVM),
)

ax = plot_countings(predictions_counting_SVM_word_doc, palette_02, "frequency (%)")
fig = ax.get_figure()
fig.savefig("visualization/results/level1/predictions_SVM_word_doc_L1.jpg")
...
# # Comparison of vectorization techniques - SVM
predictions_counting_correct_SVM = []
create_predicition_data(
    predictions_correct(predictions_count_SVM, y_test, test_sentences),
    predictions_counting_correct_SVM,
    name="count",
    format_dict_=True,
    divider=1,
...
create_predicition_data(
    predictions_correct(predictions_tfidf_SVM, y_test, test_sentences),
    predictions_counting_correct_SVM,
    name="tfidf",
    format_dict_=True,
    divider=1,
...
create_predicition_data(
    predictions_correct(
        predictions_word2vec_without_SVM, y_word2vec_without_test, test_sentences
    ),
    predictions_counting_correct_SVM,
    name="word2vec_I",
    format_dict_=True,
...
create_predicition_data(
    predictions_correct(predictions_doc2vec_without_SVM, y_test, test_sentences),
    predictions_counting_correct_SVM,
    name="doc2vec_I",
    format_dict_=True,
    divider=1,
...
create_predicition_data(
    predictions_correct(predictions_bert_SVM, y_test, test_sentences),
    predictions_counting_correct_SVM,
    name="bert",
    format_dict_=True,
    divider=1,
...
s1 = plot_countings(predictions_counting_correct_SVM, palette_01, "frequency")
s2 = sns.barplot(
    data=df_labels,
    x="kldb classes",
    y="frequency",
...
fig = s2.get_figure()
fig.savefig("visualization/results/level1/predictions_correct_relative_SVM_L1.jpg")
...
# Comparison of additional knowledge - SVM
predictions_counting_SVM_word_doc_correct = []
create_predicition_data(
    predictions_correct(
        predictions_word2vec_without_SVM, y_word2vec_without_test, test_sentences
    ),
...
create_predicition_data(
    predictions_correct(
        predictions_word2vec_with_SVM, y_word2vec_with_test, test_sentences
    ),
    predictions_counting_SVM_word_doc_correct,
    name="word2vec_II",
    format_dict_=True,
...
create_predicition_data(
    predictions_correct(predictions_doc2vec_with_SVM, y_test, test_sentences),
    predictions_counting_SVM_word_doc_correct,
    name="doc2vec_II",
    format_dict_=True,
    divider=1,
...
s1 = plot_countings(predictions_counting_SVM_word_doc_correct, palette_02, "frequency")
s2 = sns.barplot(
    data=df_labels,
    x="kldb classes",
    y="frequency",
...
fig = s2.get_figure()
fig.savefig(
    "visualization/results/level1/predictions_correct_relative_word_doc_SVM.jpg"
)
...
ax = ConfusionMatrixDisplay.from_predictions(
    y_test, predictions_tfidf_LR, cmap=cmap, include_values=False
)
plt.savefig("visualization/results/level1/cm_tfidf_LR_L1.jpg")
...
fig = ConfusionMatrixDisplay.from_predictions(
    y_test, predictions_tfidf_RF, cmap=cmap, include_values=False
)
plt.savefig("visualization/results/level1/cm_tfidf_RF.jpg")
...
# SVM
fig = ConfusionMatrixDisplay.from_predictions(
    y_test, predictions_count_SVM, cmap=cmap, include_values=False
)
plt.savefig("visualization/results/level1/cm_count_SVM_L1.jpg")

fig = ConfusionMatrixDisplay.from_predictions(
    y_test, predictions_tfidf_SVM, cmap=cmap, include_values=False
)
plt.savefig("visualization/results/level1/cm_tfidf_SVM_L1.jpg")
...
plt.savefig("visualization/results/level1/cm_word2vec_without_SVM_L1.jpg")

fig = ConfusionMatrixDisplay.from_predictions(
    y_test, predictions_doc2vec_without_SVM, cmap=cmap, include_values=False
)
plt.savefig("visualization/results/level1/cm_doc2vec_without_SVM_L1.jpg")

fig = ConfusionMatrixDisplay.from_predictions(
    y_test, predictions_doc2vec_with_SVM, cmap=cmap, include_values=False
)
plt.savefig("visualization/results/level1/cm_doc2vec_with_SVM_L1.jpg")

fig = ConfusionMatrixDisplay.from_predictions(
    y_word2vec_with_test, predictions_word2vec_with_SVM, cmap=cmap, include_values=False
)
plt.savefig("visualization/results/level1/cm_word2vec_with_SVM_L1.jpg")

fig = ConfusionMatrixDisplay.from_predictions(
    y_test, predictions_bert_SVM, cmap=cmap, include_values=False
)
plt.savefig("visualization/results/level1/cm_bert_SVM_L1.jpg")
