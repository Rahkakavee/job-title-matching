...
# load data
with open(
    file="/content/drive/MyDrive/MA/training_data_short_l3.json",
    mode="r",
    encoding="utf-8",
) as fp:
...
for key, value in data_levels.items():
    for i in range(0, 400):
      try:
        ...
        print("Number of examples in this class too low")
keys = list(data_levels.keys())

unsimilar = []
for i in range(0, 3000):
    temp = []
    key_pair = random_pairs(keys)
...
model.save("/content/drive/MyDrive/MA/bert_fine_tuning_level3")