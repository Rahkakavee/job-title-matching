...
# )
# plt.savefig("visualization/descriptive_analysis/training_data_long_L1.png")
...
plt.savefig("visualization/descriptive_analysis//training_data_long_L3.png")


# class_distribution, plt = class_distribution(
#     data=training_data_short_l5, variable="id", level="5"
# )
# plt.savefig("visualization/descriptive_analysis//training_data_long_L5.png")
