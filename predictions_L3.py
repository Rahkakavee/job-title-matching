...
fig = ax.get_figure()
fig.savefig("visualization/results/level3/predictions_LR.jpg")
...
ax = sns.heatmap(
    data=confusion_matrix(y_true=y_test, y_pred=predictions_count_LR),
    yticklabels=False,
    xticklabels=False,
    cmap="cubehelix",
)
...
pyplot.figure(figsize=(13, 13))
ax = sns.heatmap(
    data=confusion_matrix(y_true=y_test, y_pred=predictions_doc2vec_without_LR),
    yticklabels=False,
    xticklabels=False,
    cmap="cubehelix",
)
...
pyplot.figure(figsize=(13, 13))
ax = sns.heatmap(
    data=confusion_matrix(y_true=y_test, y_pred=predictions_bert_LR),
    yticklabels=False,
    xticklabels=False,
    cmap="cubehelix",
)
...
pyplot.figure(figsize=(13, 13))
ax = sns.heatmap(
    data=confusion_matrix(y_true=y_test, y_pred=predictions_count_RF),
    yticklabels=False,
    xticklabels=False,
    cmap="cubehelix",
)
...
pyplot.figure(figsize=(13, 13))
ax = sns.heatmap(
    data=confusion_matrix(y_true=y_test, y_pred=predictions_doc2vec_without_RF),
    yticklabels=False,
    xticklabels=False,
    cmap="cubehelix",
)
...
pyplot.figure(figsize=(13, 13))
ax = sns.heatmap(
    data=confusion_matrix(y_true=y_test, y_pred=predictions_bert_RF),
    yticklabels=False,
    xticklabels=False,
    cmap="cubehelix",
)
